...
import { UpdateWorkScheduleDto, WorkScheduleDto } from '../../dtos/work-schedule.dto';
...
export class UpdateWorkScheduleUseCase {
  ...
  async execute(id: number, dto: UpdateWorkScheduleDto, currentUser: JwtPayload): Promise<ApiResponseDto<WorkScheduleDto>> {
    ...
    const updatedSchedule = await this.workScheduleRepository.save(workSchedule);
