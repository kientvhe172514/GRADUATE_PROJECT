...
export class LoginRequestDto {
  ...
  @ApiPropertyOptional({ example: 'abc123-device-id', description: 'Unique device identifier' })
  @IsOptional()
  @IsString()
  device_id?: string;

  @ApiPropertyOptional({ example: 'Samsung Galaxy S23', description: 'Device name' })
  @IsOptional()
  @IsString()
  device_name?: string;
  ...
  @ApiPropertyOptional({ enum: DevicePlatform, example: DevicePlatform.ANDROID, description: 'Device platform' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: { latitude: 10.762622, longitude: 106.660172 }, description: 'Device location' })
  @IsOptional()
  location?: any;

  @ApiPropertyOptional({ example: 'fcm-token-xyz', description: 'FCM token for push notifications' })
  @IsOptional()
  @IsString()
  fcm_token?: string;
}