...
export const ErrorMessages: Record<ErrorCodes, string> = {
  ...
  [ErrorCodes.DEPARTMENT_CODE_ALREADY_EXISTS]: 'Department code already exists',
  [ErrorCodes.DEPARTMENT_NAME_ALREADY_EXISTS]: 'Department name already exists',
...
export const ErrorStatusCode: Record<ErrorCodes, number> = {
  ...
  [ErrorCodes.DEPARTMENT_CODE_ALREADY_EXISTS]: 409,
  [ErrorCodes.DEPARTMENT_NAME_ALREADY_EXISTS]: 409,
