...
export const AccountPermissionSchema = new EntitySchema<AccountPermissionEntity>({
  ...
  indices: [
    ...
    { name: 'idx_account_permissions_permission_id', columns: ['permission_id'] },
    { name: 'idx_account_permissions_unique', columns: ['account_id', 'permission_id'], unique: true },
  ],
});
