...
import { ListWorkScheduleDto, WorkScheduleDto } from '../../dtos/work-schedule.dto';
...
export class ListWorkSchedulesUseCase {
  ...
  async execute(dto: ListWorkScheduleDto): Promise<ApiResponseDto<{ data: WorkScheduleDto[]; total: number }>> {
