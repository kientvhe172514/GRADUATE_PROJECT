...
export interface DeviceSessionRepositoryPort {
  ...
  update(id: number, deviceSession: Partial<DeviceSession>): Promise<DeviceSession>;
  ...
  revokeAllByAccountId(accountId: number, revokedBy: number, reason: string): Promise<void>;
