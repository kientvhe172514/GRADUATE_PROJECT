...
export class AttendanceEditLogEntity {
  ...
  @Column({
    ...
    length: 100,
    comment:
      'Tên field bị sửa: check_in_time, check_out_time, status, work_hours...',
  })
  ...
  @Column({
    type: 'text',
    nullable: true,
    comment: 'Lý do sửa điểm danh do HR nhập',
  })
  ...
  @Column({
    ...
    length: 45,
    nullable: true,
    comment: 'IP address của HR khi edit',
  })
